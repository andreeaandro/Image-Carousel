            ...
            ScrollView {
                ZStack {
                    VStack(alignment: .leading, spacing: 5) {
                        ...
                        Text("Growing up in Michigan, I was lucky enough to experience one part of Great Lakes. And let me assure you, they are great. As a photojournalist, I have had endless opportunities to travel the world and to see a variety of lakes, as well as each of the major oceans. And let me tell you, you will be hard pressed to find water as beautiful as the Great Lakes.")
                            .padding(.bottom, 40)
